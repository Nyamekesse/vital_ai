jQuery(document).ready(function () {
  ...
  jQuery(".twbb-pu-upgrade-layout, .twbb-pu-upgrade-container").removeAttr("style").removeClass("twbb-pu-hidden");
    if( !jQuery(".twbb-pu-upgrade-container").hasClass("tbdemo-upgrade-container") ) {
  ...
  jQuery(".tbdemo-switch, .tbdemo-plans_tab").on("click", function() {
    ...
    if( jQuery(this).hasClass("tbdemo-active_monthly") || jQuery(this).hasClass("tbdemo-plan_annual") ) {
        ...
        let new_url = change_url_param( url, 'subscr_id', 165 );
        ...
        new_url = change_url_param( url, 'subscr_id', 173 );
        ...
        let new_url = change_url_param( url, 'subscr_id', 163 );
        jQuery(".tbdemo-upgrade-personal .tbdemo-upgrade-price-button, .tbdemo-upgrade-personal .tbdemo-upgrade-price-button-mobile").attr("href", new_url);
        new_url = change_url_param( url, 'subscr_id', 171 );
        jQuery(".tbdemo-upgrade-agency .tbdemo-upgrade-price-button, .tbdemo-upgrade-agency .tbdemo-upgrade-price-button-mobile").attr("href", new_url);
    }
  });
...
function change_url_param( url, param, value ) {
  url = new URL(url);
...
function swipePrice( window_size ) {
